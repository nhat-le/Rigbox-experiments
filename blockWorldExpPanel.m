classdef blockWorldExpPanel < eui.ExpPanel
  ...
  methods
    function obj = blockWorldExpPanel(parent, ref, params, logEntry)
      ...
      for ui = 1:length(updates)
        ...
        switch signame
          case {'events.azimuth', 'events.contrast', 'outputs.reward', ...
                  ...
                  'events.repeatNum', 'events.timeout',...
                  'events.totalReward', 'events.correctThreshold',...
