...
start = events.expStart.scan(@plus, 0);
startTrial = start.at(events.newTrial);
azimuth_default = wheel.at(events.expStart);
azimuth = cond(start, wheel, true, 0);
