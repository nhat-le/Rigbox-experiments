function blockWorldPlusPerformance(t, evts, p, vs, in, out, audio)
%% Adapted from: blockWorld
% Similar to blockWorld, but repeat errors
...
counter = cond(feedback > 0, counter , true, 1 - counter);
